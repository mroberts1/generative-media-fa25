...
`;
      ...
      try {
        if (window.shaderParkCore && window.shaderParkCore.sculptToMinimalRenderer) {
          window.shaderParkCore.sculptToMinimalRenderer(canvas, code);
        } else if (window.shaderParkCore && window.shaderParkCore.default && window.shaderParkCore.default.sculptToMinimalRenderer) {
          window.shaderParkCore.default.sculptToMinimalRenderer(canvas, code);
        }
      } catch (e) {
